...
#if defined(custom_xuf)
#define P_GPIO_DSD_MODE         (1 << 0) /* DSD mode select 0 = 8i/8o I2S, 1 = 8o DSD*/
#define P_GPIO_DAC_RST_N        (1 << 1)
#define P_GPIO_P8C2             (1 << 2)
#define P_GPIO_MCLK_22M         (1 << 3) /* Select crystal 1 = 22.5792MHz for 44.1k.*/
#define P_GPIO_P8C4             (1 << 4)
#define P_GPIO_P8C5             (1 << 5)
#define P_GPIO_ADC_RST_N        (1 << 6)
#define P_GPIO_MCLK_24M         (1 << 7) /* Select crystal 1 = 24.576MHz for 48k*/

#elif XCORE_200_MC_AUDIO_HW_VERSION == 2
