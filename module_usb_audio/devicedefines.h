 ...
 */
    ...
    #define NUM_USB_CHAN_IN 0 /* Define anyway for doxygen */
#endif
 ...
 */
    ...
    #define I2S_CHANS_ADC 0      /* Define anyway for doxygen */
#else
#define I2S_WIRES_ADC 0            /* (I2S_CHANS_ADC / I2S_CHANS_PER_FRAME) */
#endif
 ...
 */
    ...
    #define MCLK_441             (1024 * 44100) /* Define anyway for doygen */
#endif
 ...
 */
    ...
    #define MCLK_48              (1024 * 48000) /* Define anyway for doygen */
#endif
 ...
 */
#ifndef AUDIO_CLASS_FALLBACK     /* Default to not falling back to UAC 1 */
#endif
